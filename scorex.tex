...
interfaces~(possibly reusing code previously written for our projects).

Scorex is intended to build a fullnode implementation, though other security models are possible~(e.g. SPV).
...
A fullnode node is about to get the same \textit{minimal state} representation eventually for a version $h$ as other honest
nodes.

\subsection{Node View Component}
